              ...
              <div className="flex items-start gap-6">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-5 mt-2">
                    ...
                    <p className="text-xs sm:text-lg font-medium border bg-slate-50">
                      {" "}
                      {item.size}
                    </p>
                  </div>
      ...
      <div className="flex justify-end my-20">
        <div className="w-full sm:w-[450px]">
          ...
          <div className="w-ful text-end">
            <button onClick={()=>navigate("/place-order")} className="bg-red-500 text-white text-sm my-8 px-8 py-3"> Proceed To Checkout</button>
          </div>
